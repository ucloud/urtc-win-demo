...
typedef enum _tUCloudRtcCallbackErrCode {
	...
	UCLOUD_RTC_CALLBACK_ERR_INVAILDSTATE, // 服务端连接断开
	UCLOUD_RTC_CALLBACK_ERR_INVAILDPARAMETER, // 无效参数
	...
	UCLOUD_RTC_CALLBACK_ERR_MSG_RECORDDVICEERR, //mic 录音设备出错
...
typedef enum _tUCloudRtcReturnErrCode {
    ...
    UCLOUD_RTC_RETURN_ERR_INVAILED_STATE,   //内部状态错误
    UCLOUD_RTC_RETURN_ERR_INVAILED_POINTER,   //指针错误
